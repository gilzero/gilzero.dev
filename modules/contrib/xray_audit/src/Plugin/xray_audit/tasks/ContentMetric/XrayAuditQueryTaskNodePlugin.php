 ...
 *       },
 *      "node_with_by_revisions" = {
 *          "label" = "Nodes with the highest number of revisions",
 *          "description" = "Identify the nodes with the highest number of entries in the node_revision table, including revisions across all languages, representing those with the most revisions. The results should display the top twenty nodes with the greatest number of revisions."
 *       }
 *    },
 *   dependencies = {"node"}
 * )
