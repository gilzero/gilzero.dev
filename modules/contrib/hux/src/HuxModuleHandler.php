...
final class HuxModuleHandler implements ModuleHandlerInterface {
  ...
  public function invokeAllWith(string $hook, callable $callback): void {
    ...
    $callback = static function (callable $hookInvoker, string $module) use ($callback, $replacements): void {
  ...
  public function invokeAll($hook, array $args = []) {
    ...
    $return = [];
    $this->invokeAllWith($hook, static function (callable $hookInvoker, string $module) use ($args, &$return): void {
  ...
  private function generateInvokers(string $hook): \Generator {
    ...
    \usort($hooks, static function (array $a, array $b) {
      [2 => $aPriority] = $a;
      [2 => $bPriority] = $b;
