 ...
 */
#[AiAutomatorType(
  id: 'scrapingbot_title_string',
  label: new TranslatableMarkup('ScrapingBot: Title Crawler'),
  field_rule: 'string',
  target: '',
)]
class TitleCrawler extends ExternalBase implements AiAutomatorTypeInterface, ContainerFactoryPluginInterface {
   ...
   * {@inheritDoc}
   */
  public $title = 'ScrapingBot: Title Crawler';
  ...
  public function generate(ContentEntityInterface $entity, FieldDefinitionInterface $fieldDefinition, array $automatorConfig) {
    ...
    return ['value' => $done ? $readability->getTitle() : ''];
