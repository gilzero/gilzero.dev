...
radzero theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of radzero theme and run the following commands:
`nvm use`
...
`drush en radzero -y`
`drush config-set system.theme default radzero -y`
